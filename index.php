...
<link rel="shortcut icon" href="assets/images/favicon-icon/24x24.jpg">
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>GET A CHANCE TO RIDE YOUR FAVOURITE MOTORCYCLE</h1>
            <p>Explore the area by riding yourself </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best Bike or scooter For You</h2>
      <p>You will be able to fully enjoy your holiday and your ride! Any problems? Our passionate team will be happy to help you!! No waste of time during your holidays to find a rental point on the spot! We have best bikes and scooters with best deals</p>
    </div>
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New collections</a></li>
        </ul>
      </div>
