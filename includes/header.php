  ...
  <div class="default-header">
    <div class="container">
      <div class="row">
        ...
        <div class="logo"> <a href="index.php"><img src="assets/images/logg22.jpg" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">vehiren2021@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:61-1234-5678-09">+91-8113950921</a> </div>
...
echo "Welcome To VEHIREN portal";
 } ?>
          </div>
        </div>
      </div>
