...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,Address,pincode,city,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:address,:pincode,:city,:status)";
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Share: <a href="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a> </p>
        </div>
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
                  <input type="text" class="form-control" name="pincode" placeholder="pincode" maxlength="10" required="required">
                </div>
            </select>
							</div>
