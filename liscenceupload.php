...
{
$liscence=$_FILES["file"]["name"];
move_uploaded_file($_FILES["file"]["tmp_name"],"img/liscence/".$_FILES["file"]["name"]);


$sql="update tblusers set liscence=:liscence";
$query = $dbh->prepare($sql);
$query->bindParam(':liscence',$liscence,PDO::PARAM_STR);
$query->execute();
